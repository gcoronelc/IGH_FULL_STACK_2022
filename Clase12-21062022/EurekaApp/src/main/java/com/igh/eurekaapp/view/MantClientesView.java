...
public class MantClientesView extends javax.swing.JInternalFrame {
   ...
   private void initComponents() {
      ...
      btnExpotarPDF.addActionListener(new java.awt.event.ActionListener() {
         public void actionPerformed(java.awt.event.ActionEvent evt) {
            btnExpotarPDFActionPerformed(evt);
         }
      });
  ...
  private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
	  try {
		  ...
		  // Proceso
		  listaClientes = control.readAll(bean);
		  // Reporte
		  cargarReporte();
	  } catch (Exception e) {
  ...
  private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
	  ...
	  view.setBean(listaClientes.get(fila));
	  Session.put("bean", null);
	  view.setVisible(true);
	  if (Session.get("bean") == null) {
		  return;
	  }
	  ClienteModel bean = (ClienteModel) Session.get("bean");
	  listaClientes.set(fila, bean);
  ...
  private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
   ...
   private void btnExportarExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarExcelActionPerformed
		...
		try {
			// Creación del libro
			String plantilla = "/plantillas/ListadoClientes.xls";
			...
			for (ClienteModel model : listaClientes) {
				...
				crearCeldaCadena(objFila, 0, model.getCodigo());
				crearCeldaCadena(objFila, 1, model.getPaterno());
				crearCeldaCadena(objFila, 2, model.getMaterno());
			}
			// Se vuelca la información a un archivo.
			FileOutputStream fileOut = new FileOutputStream("E://Archivos//CLINTES.xls");
   ...
   private void btnExpotarPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExpotarPDFActionPerformed
		// TODO add your handling code here:
   }//GEN-LAST:event_btnExpotarPDFActionPerformed
   ...
   // End of variables declaration//GEN-END:variables
	...
	private void cargarReporte() {
		...
		tabla.setRowCount(0);
		// Cargar datos
		for (ClienteModel o : listaClientes) {
